    ...
    <div className="flex pt-5 px-3 flex-col gap-4">
      ...
      <Card className="h-full lg:overflow-hidden overflow-x-scroll w-full px-6">
        <table className="w-full min-w-max table-auto text-left">
          ...
          <tbody>
            {currentData.map(({ first_name,value, Turma, last_name, created_at, img, email, status, id }, index) => {
                ...
                <tr key={id} className="hover:bg-gray-50">
                  ...
                  <td style={{ position: "relative" }} className={classes}>
                    ...
                    <Card
                      ...
                      } ${isLast ? "-top-20" : "top-0"} right-16 absolute w-[135px]`}
                    >
                      <List className="w-[120px] text-xs">
                        ...
                        <ListItem onClick={() => deleteData(id)} className="text-xs w-[120px] font-semibold">
                          <ListItemPrefix>
                            <BsFillTrashFill />
                          </ListItemPrefix>
                          Excluir
